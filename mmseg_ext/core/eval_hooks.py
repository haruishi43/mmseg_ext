...
class EvalSegHook(EvalHook):
    ...
    def _do_evaluate(self, runner):
        ...
        from mmseg_ext.apis import single_gpu_seg_test

        results = single_gpu_seg_test(
...
class DistEvalSegHook(DistEvalHook):
    ...
    def _do_evaluate(self, runner):
        ...
        from mmseg_ext.apis import multi_gpu_seg_test

        results = multi_gpu_seg_test(
            runner.model,
            self.dataloader,
            tmpdir=tmpdir,
...
class EvalEdgeHook(EvalHook):
    ...
    def _do_evaluate(self, runner):
        ...
        from mmseg_ext.apis import single_gpu_edge_test
...
class DistEvalEdgeHook(DistEvalHook):
    ...
    def _do_evaluate(self, runner):
        ...
        from mmseg_ext.apis import multi_gpu_edge_test
