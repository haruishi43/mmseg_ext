...
"""
FIXME:
- binary cross entropy doesn't work when there are only a single class (or background (ignore) class)
"""
...
def binary_cross_entropy(
    ...
    if pred.size(1) == 1:
        ...
        # FIXME: sometimes, we might have labels that is only background!
...
@SEG_LOSSES.register_module(force=True)
